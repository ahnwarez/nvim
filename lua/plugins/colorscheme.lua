local function vscode_config()
	...
	vscode.setup({
		...
		group_overrides = {
			...
			["@punctuation.bracket.tsx"] = { fg = "#ffcc00", bg = "NONE" },
			...
			["@tag.builtin.tsx"] = { fg = colors.vscBlue, bg = "NONE" },
			...
			["@keyword.function.tsx"] = { fg = colors.vscBlue, bg = "NONE" },

			-- `namespace` `interface`
			["@keyword.type.typescript"] = { fg = colors.vscBlue, bg = "NONE" },
			["@keyword.type.tsx"] = { fg = colors.vscBlue, bg = "NONE" },

			-- `async funcion`
			["@keyword.coroutine.typescript"] = { fg = colors.vscBlue, bg = "NONE" },
			["@keyword.coroutine.tsx"] = { fg = colors.vscBlue, bg = "NONE" },

			-- `? :` ternary operator
			["keyword.conditional.ternary.typescript"] = { fg = "#777777", bg = "NONE" },
			["keyword.conditional.ternary.tsx"] = { fg = "#777777", bg = "NONE" },
		},
	})
	vscode.load()
